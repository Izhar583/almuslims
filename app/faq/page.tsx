...
const faqs = [
  ...
  },
  {
    ...
    answer: "For technical issues or general inquiries, you can reach out via our Contact Us page or email support@almuslims.com. Our support team is available 24/7.",
  },
];
...
function FAQItem({ question, answer, isOpen, onClick }: { question: string, answer: string, isOpen: boolean, onClick: () => void }) {
  return (
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        <span className={`text-[15px] font-bold transition-colors ${isOpen ? "text-primary" : "text-gray-700 group-hover:text-primary"}`}>
          {question}
        </span>
           ...
           <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="max-w-2xl">
                 ...
                 <p className="text-gray-500 text-lg leading-relaxed mb-8">
                    Find answers to common questions about Islam, our platform, and how to make the most of AlMuslims.
                 </p>
              </div>
         ...
         <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-[#0A3A2F] rounded-[3rem] p-10 text-center text-white relative overflow-hidden group">
               <div className="relative z-10">
                  <h3 className="font-heading text-2xl font-bold mb-4">Still Need Help?</h3>
                  ...
                  <p className="text-white/60 text-xs leading-relaxed mb-8 px-4">
                    Our scholars are here to help you with any Islamic question. Typically responds within 24-48 hours.
                  </p>
                  <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary font-black text-[11px] uppercase tracking-widest rounded-2xl hover:bg-secondary hover:text-white transition-all shadow-xl">
                     <HiOutlineChatBubbleLeftRight className="w-4 h-4" /> Ask a Scholar
                  </Link>
               </div>
